...
@Component({
  selector: 'app-cord-add',
  templateUrl: './cord-add.component.html',
  styleUrls: ['./cord-add.component.scss']
})
export class CordAddComponent implements OnInit {
...
fromdateval:any='';
  ...
  ngOnInit(): void {
    console.log('token',LocalStorage.getValue('token'))
...
display(temp:any){
  ...
  cordinator(val:any){   
    ...
    this.loader = true;
    this.server.fileUpload("adminuser",senddata,true,(res:any={})=>{     
